...
import (
	...
	v3electiongw "github.com/ozonru/etcd/etcdserver/api/v3election/v3electionpb/gw"
	"github.com/ozonru/etcd/etcdserver/api/v3lock"
	"github.com/ozonru/etcd/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "github.com/ozonru/etcd/etcdserver/api/v3lock/v3lockpb/gw"
	"github.com/ozonru/etcd/etcdserver/api/v3rpc"
	etcdservergw "github.com/ozonru/etcd/etcdserver/etcdserverpb/gw"
