...
running(leaking) after all tests.
	...
	import "github.com/ozonru/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/ozonru/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "github.com/ozonru/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
